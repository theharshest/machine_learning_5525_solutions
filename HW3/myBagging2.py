...
def decision_tree(filename, train_data):
    '''
    ...
    # the lowest entropy
    entropies = [get_entropy(train_data, i+1) for i in range(n_features)]
    ...
    for data in datas:
        ...
        for i in range(n_features):
            if i+1 not in attrs:
                ...
                entropies.append(sys.float_info.max)
...
def myBagging2(filename, B):
    '''
    Main bagging classifier function
    '''
    data = get_data(filename)
    ...
    for b in B:
        ...
        for i in range(10):
            ...
            for j in range(b):
                ...
                split1, split2, labels = decision_tree(filename, train_data)
        ...
        print "Number of classifiers: " + str(b)
